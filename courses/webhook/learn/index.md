...
One program that grows for twenty stages: an HTTPS server that registers
...
3. **Stages 12-20 — behaving in production.** Honour a dry run, choose a
   ...
   CEL, express the same rule with no webhook at all, and never gate yourself.
