...
One program that grows for twenty-five stages: an HTTPS server that registers
...
3. **Stages 12-25 — behaving in production.** Honour a dry run, choose a
   ...
   into a running pod, let a namespace go, and move a rule's data out of code.
